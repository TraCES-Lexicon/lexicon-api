...
public class QueryApiServiceImpl extends QueryApiService {
    ...
    public Response queryGet(String string, Boolean translit, SecurityContext securityContext) throws NotFoundException {
    	...
    	if (translit) {
    		result = new Result().transliteration(string).fidael("Fidäl string will be generated by logic in future versions.");
    	}
    	else {
    		result = new Result().fidael(string).transliteration("Transliteration string will be generated by logic in future versions.");
    	}
    	result.query(string);
